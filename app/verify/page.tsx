  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-background selection:bg-foreground/10">
      <div className="w-full max-w-md space-y-10 relative z-10">
        ...
        <div className="space-y-6 p-8 rounded-2xl bg-card border border-border/50 shadow-sm backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="text-center relative z-10">
            {error ? (
              <p className="text-sm text-destructive font-medium animate-in fade-in slide-in-from-bottom-1 mb-4">{error}</p>
            ) : isVerifying ? (
              <p className="text-sm text-muted-foreground font-medium animate-pulse flex items-center justify-center gap-2 mb-4">
